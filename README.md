...
| **Soleil** (inventé, **boss**) | Couronne de rayons — **huit rayons à la fois**, un tous les 45°, et **ils ne blessent pas** : c'est sa silhouette, plus son arme | **fait pour gagner contre tous les autres en 1 contre 1**, et il le fait (21/21). **Deux fois plus grand** que la norme (rayon 82 contre 41), **500 PV**, et **le plus lent du jeu de très loin** (230 px/s). Tout passe par son ultime : le coller ne coûte rien, mais c'est de près que le faisceau est inesquivable. Réchauffement solaire : brûle qui reste dans 240 px | Rayon solaire / SOLAR BEAM — **2 s de charge annoncée à l'écran** (anneaux qui se referment, foyer qui bat), puis **2,5 s** d'un faisceau de 124 px qui traverse l'arène, jusqu'à 96 PV |
