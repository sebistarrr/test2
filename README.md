...
| **Neon Shadow** (inventé) | Dagues du vide enchaînées — une dague **braquée** sur la cible, et une **seconde au bout d'une chaîne** qui traîne, se déporte en virage et blesse ce qu'elle frôle | **il glisse** : images fantômes permanentes, il éclate en pixels d'ombre quand il encaisse, se téléporte dans le dos de sa cible (Pas du vide) et pose des pièges (Faille du vide) | Éclipse totale / TOTAL ECLIPSE — **l'arène passe au noir**, il ne reste que les contours néon, neuf frappes depuis des angles au hasard, puis un flash blanc |
